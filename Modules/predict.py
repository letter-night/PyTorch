"""
Predict on a target image given a file path with a saved model.
"""
import torch
import torchvision
import argparse
...
# Get a model path
parser.add_argument("--model_path", default="models/tinyvgg_model.pth", type=str, help="target model to use for prediction filepath")
...
def predict_on_image(image_path=IMG_PATH, filepath=args.model_path):
	...
	# Load in the image and turn it intotorch.float32 (same type as model)
...
"""
Comand line: python predict.py --image data/pizza_steak_sushi/test/sushi/175783.jpg
"""