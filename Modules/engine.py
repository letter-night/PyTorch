...
def create_writer(experiment_name:str,
    ...
    Args:
        ...
        extra (str, optional): Anything extra to add to the directory. Default to None.

    Returns:
        torch.utils.tensorboard.writer.SummaryWriter(): instance of a writer saving to log_dir.

    Example usage:
    # Create a writer saving to "runs/2024-02-14/data_10_percent/effnetb2/5_epochs/"
    writer = create_writer(experiment_name="data_10_percent",
                                        model_name="effnetb2",
                                        extra="5_epochs")
    # The above is the same as:
    writer = SummaryWriter(log_dir="runs/204-02-14/data_10_percent/effnetb2/5_epochs/")
    """
